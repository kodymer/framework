...
{
    public class AzureServiceBusEventBus : EventBusBase<AzureServiceBusMessage, AzureServiceBusReceivedMessage>, IDistributedEventBus
    {

        private readonly AzureServiceBusEventBusOptions _eventBusOptions;
        ...
        public AzureServiceBusEventBus(
            ...
            IOptions<AzureServiceBusEventBusOptions> eventBusOptions,
