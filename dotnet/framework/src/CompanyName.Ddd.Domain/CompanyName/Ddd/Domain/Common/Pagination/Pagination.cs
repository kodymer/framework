...
namespace CompanyName.Ddd.Domain.Common.Pagination
{
    public class Pagination
    {
        ...
        public Pagination(int itemsCount, PaginationFilter paginationFilter)
            : this(new PaginationSettings(10, 100), itemsCount, paginationFilter.PageSize, paginationFilter.Page)
        {
        }

        public Pagination(PaginationSettings paginationSettings, int itemsCount, PaginationFilter paginationFilter)
            : this(paginationSettings, itemsCount, paginationFilter.PageSize, paginationFilter.Page)
        {
        }
