        ...
        public void Map(IEndpointRouteBuilder app)
        {
            app
                .MapGet(
                    ...
                    async Task<Results<Ok<List<BankTransferDto>>, NotFound>> (/*[FromServices] IScopedMediator mediator,*/ CancellationToken cancellationToken = default) =>
                    {
                        ...
                        return TypedResults.Ok<List<BankTransferDto>>(null);
                    }
                 )
